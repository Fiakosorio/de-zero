    ...
    <header className="bg-white dark:bg-gray-800 shadow sticky top-0 z-50">
      <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <ul className="flex space-x-6 text-cyan-500 font-semibold">
          <li><a href="#hero" className="hover:text-cyan-700 dark:hover:text-cyan-300">Inicio</a></li>
          ...
          <li><a href="#contacto" className="hover:text-cyan-700 dark:hover:text-cyan-300">Contacto</a></li>
        </ul>
        <button
